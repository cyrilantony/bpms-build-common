...
COMPONENTS = [["pxe",PXE_VERSION,PXE_COMPONENTS], ["bpms-console", BPMS_CONSOLE_VERSION, ""], ["bpms-analytics", BPMS_ANALYTICS_VERSION, ""], ["bpms-pdfgen", BPMS_PDFGEN_VERSION, ""], ["bpms-webmodeler", BPMS_WEBMODELER_VERSION, ""], ["bpms-dashboard",BPMS_DASHBOARD_VERSION,""],["ode-validator", ODE_VALIDATOR_VERSION,""], ["axis2-services",AXIS2SERVICES_DEPLOY_WS_VERSION,AXIS2_COMPONENTS], ["gi-webapp",GI_WEBAPP_VERSION,""], ["wsi",WSI_VERSION,""], ["ui-fw",UIFW_VERSION,""], ["wds", WDS_VERSION,""], ["xforms-manager",XFORMS_MANAGER_VERSION, ""],["tomcat-5",TOMCAT_5_VERSION,""],["server-common","",""],["tmp-process-handler", TMP_PROCESS_HANDLER_VERSION,TMP_PROCESS_HANDLER_COMPONENT], ["social", SOCIAL_VERSION, ""]]
...
COMPONENTS_EE = [["bpms-dashboard",BPMS_DASHBOARD_VERSION, ""], ["pxe-ha", PXE_HA_VERSION,PXE_HA_COMPONENTS], ["bpms-console", BPMS_CONSOLE_VERSION, ""], ["bpms-analytics", BPMS_ANALYTICS_VERSION, ""], ["bpms-pdfgen", BPMS_PDFGEN_VERSION, ""], ["bpms-webmodeler", BPMS_WEBMODELER_VERSION, ""], ["bpms-team", TEMPO_VERSION, ""], ["bpms-adhocreport", BPMS_ADHOCREPORT_VERSION, ""], ["collaboration",COLLABORATION_VERSION,""], ["mobi", MOBI_VERSION, ""], ["ode-validator", ODE_VALIDATOR_VERSION,""], ["axis2-services", AXIS2SERVICES_DEPLOY_WS_VERSION, AXIS2_COMPONENTS_EE], ["webreport", WEBREPORT_VERSION,""],["gi-webapp", GI_WEBAPP_VERSION,""],["wsi", WSI_VERSION,""],["ui-fw", UIFW_VERSION, ""],["wds", WDS_VERSION, ""], ["bre", "", BRE_COMPONENTS],["apacheds-webapp", APACHEDS_WEBAPP_VERSION,""],["cas-webapp", CAS_WEBAPP_VERSION, ""],["server-common", "", ""],["tmp-process-handler", TMP_PROCESS_HANDLER_VERSION, TMP_PROCESS_HANDLER_COMPONENT], ["social", SOCIAL_VERSION, ""], ["consolidation", INTALIO_VERSION, ""]]
